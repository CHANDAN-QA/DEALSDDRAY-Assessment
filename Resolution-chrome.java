...
public class Resolution {
	...
	public static void main(String[] args) throws InterruptedException, IOException 
	{
		...
		File dst = new File("C:\\Users\\CHANDAN L\\Desktop\\Screenshots\\photo1.jpeg");
		...
		driver.navigate().back();
		 ...
		 Dimension d1 = new Dimension(1366,768);
		  driver.manage().window().setSize(d1);
			...
			File dst1 = new File("C:\\Users\\CHANDAN L\\Desktop\\Screenshots\\photo2.jpeg");
			...
			driver.navigate().back();
			 ...
			 Dimension d2 = new Dimension(1536,864);
			  driver.manage().window().setSize(d2);
				...
				File dst2 = new File("C:\\Users\\CHANDAN L\\Desktop\\Screenshots\\photo3.jpeg");
